...
function RobotSpeaker() {
    //var mobileDevice = (navigator.userAgent.toLowerCase().search(/mobile/) == -1) ? false : true;
    try {
    ...
    this.u.rate = (navigator.userAgent.toLowerCase().search(/iphone|ipod|ipad/) > -1) ? 0.2 : 1.0;
    ...
    this.speak = function (lang, text) {
        ...
        this.u.text = text;
        //this.u.rate = (navigator.userAgent.toLowerCase().search(/mobile/) > -1) ? 0.9 : 1.0;
        //this.u.rate = (navigator.userAgent.toLowerCase().search(/iphone|ipod|ipad/) > -1) ? 0.2 : 1.0;
